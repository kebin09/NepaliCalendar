...
import { FaHeartPulse, FaCalendarCheck, FaBell, FaWeightScale } from "react-icons/fa6";
        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-x-8 md:gap-y-16 lg:grid-cols-4">
          <div>
            <div className="mb-5 md:mb-6">
              <FaHeartPulse className="size-12" aria-hidden="true" />
            </div>
          ...
          <div>
            <div className="mb-5 md:mb-6">
              <FaBell className="size-12" aria-hidden="true" />
            </div>
            <h3 className="mb-3 text-xl font-bold md:mb-4 md:text-2xl">
          ...
          <div>
            <div className="mb-5 md:mb-6">
              <FaWeightScale className="size-12" aria-hidden="true" />
            </div>
            <h3 className="mb-3 text-xl font-bold md:mb-4 md:text-2xl">
