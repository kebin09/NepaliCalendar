...
import { FaListCheck, FaClipboardList, FaShieldHalved, FaReceipt } from "react-icons/fa6";
          ...
          <div className="grid grid-cols-1 items-start gap-y-12 md:grid-cols-2 md:gap-x-8 md:gap-y-16 lg:grid-cols-4">
            <div className="w-full">
              <div className="mb-5 flex justify-center md:mb-6">
                <FaListCheck className="size-12" aria-hidden="true" />
              </div>
            ...
            <div className="w-full">
              <div className="mb-5 flex justify-center md:mb-6">
                <FaClipboardList className="size-12" aria-hidden="true" />
              </div>
              <h3 className="mb-3 text-center text-xl font-bold md:mb-4 md:text-2xl">
                विवरणहरू भर्नुहोस्
              </h3>
            ...
            <div className="w-full">
              <div className="mb-5 flex justify-center md:mb-6">
                <FaReceipt className="size-12" aria-hidden="true" />
              </div>
              <h3 className="mb-3 text-center text-xl font-bold md:mb-4 md:text-2xl">
